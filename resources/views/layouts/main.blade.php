...
<header>
    <nav class="navbar navbar-expand-lg text-light  navbar-light  ">
        ...
        <ul class="nav" >
            ...
            <li class="nav-item"><a class="nav-link text-black " href="{{ route('noticias') }}">Blog</a></li>
            @if(Auth::check())
            ...
            @if(Auth::check())
                @if(auth()->user()->admin)
            <li class="nav-item"><a class="nav-link text-black  " href="{{ route('admin/noticias') }}">Ir al Panel</a></li>
                @endif
                    <li class="nav-item">
            ...
            @else
                <li class="nav-item"><a class="nav-link text-black" href="{{ route('auth/login/form') }}">Iniciar Sesión</a></li>
                <li class="nav-item"><a class="btn nav-link text-success" href="{{ route('registro') }}">Registrate</a></li>
            @endif
