...
/**@var \Illuminate\Database\Eloquent\Collection|\App\Models\Etiquetas::[] $etiquetas */
?>
...
@section('main')
    ...
    <form action="{{ route ("admin/noticias/nueva-grabar")}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
            <label for="titulo" class="form-label">Título (al menos dos caracteres)</label>
